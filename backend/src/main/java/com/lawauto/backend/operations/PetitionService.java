...
public class PetitionService {
    ...
    public List<PetitionDto> listByOrg(UUID orgId) {
        String sql = """
                select "id", "orgId", "matterId", "title", "body", "fileId", "createdByUserId", "createdAt"
                from "Petition" 
        ...
        return jdbc.query(sql, new MapSqlParameterSource("orgId", orgId), (rs, n) -> new PetitionDto(
                ...
                rs.getString("title"), 
                rs.getString("body"), 
                rs.getObject("fileId", UUID.class),
    ...
    public UUID create(CreatePetitionRequest req) {
        ...
        String sql = """
                insert into "Petition" ("id", "orgId", "matterId", "title", "body", "fileId", "createdByUserId", "updatedAt")
                values (:id, :orgId, :matterId, :title, :body, :fileId, :createdByUserId, now())
                """;
