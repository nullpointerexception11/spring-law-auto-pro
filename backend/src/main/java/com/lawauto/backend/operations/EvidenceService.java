...
public class EvidenceService {
    ...
    public List<EvidenceDto> listByOrg(UUID orgId) {
        String sql = """
                select "id", "orgId", "matterId", "description", "fileId", "createdByUserId", "createdAt"
                from "Evidence" 
    ...
    public UUID create(CreateEvidenceRequest req) {
        ...
        String sql = """
                insert into "Evidence" ("id", "orgId", "matterId", "description", "fileId", "createdByUserId")
                values (:id, :orgId, :matterId, :description, :fileId, :createdByUserId)
                """;
