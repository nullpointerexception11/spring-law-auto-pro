  ...
  const [messages, setMessages] = useState([
    {
      id: 'welcome',
      role: 'assistant',
      content: 'Merhaba! Ben LawAuto Yapay Zeka Asistanı.\n\nSize dava süreçleri, mevzuat araştırmaları veya doküman özetleme konularında yardımcı olabilirim.'
    }
  ]);
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] rounded-lg border border-border bg-card">
      ...
      <div className="flex items-center gap-3 px-5 py-3.5 border-b border-border">
        ...
        <div>
          <h2 className="text-sm font-medium text-foreground">AI Asistan</h2>
          <p className="text-xs text-muted-foreground">Spring AI ile güçlendirilmiş hukuk asistanı</p>
        </div>
      </div>
      ...
      <div className="px-5 py-3.5 border-t border-border">
        ...
        <p className="text-[10px] text-muted-foreground mt-2 text-center">
          Yapay zeka hatalar yapabilir, önemli kararlar öncesi doğrulayın.
        </p>
      </div>
    </div>
  );
